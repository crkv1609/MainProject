...
document.querySelectorAll('#id_mobile_number,#id_ref1mobilenumber,#id_ref2mobilenumber').forEach((ele)=>{
...
//   });
   ...
   // Only characters in input
 document.querySelectorAll('#id_student_name,#id_country,#id_course,#id_university_name,#id_co_applicant_parent_name,#id_ref1name,#id_ref2name').forEach((item)=>{
...
console.log(document.querySelector('#id_required_loan_amount').hasAttribute('required'));


document.querySelectorAll('#id_required_loan_amount,#id_co_applicant_salaried_net_pay,#id_co_applicant_salaried_emis,#id_co_pplicant_self_employed_itr_amount,#id_property_market_value,#id_property_govt_value').forEach((id) => {
