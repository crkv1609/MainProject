...
const loanTenureInput = document.getElementById('loan-tenure'); // now input in months
const loanTenureSlider = document.getElementById('loan-tenure-slider'); // now slider in months
...
function calculateEMI() {
    ...
    const loanTenure = parseFloat(loanTenureInput.value); // already in months
...
// Sync input and sliders, then calculate
